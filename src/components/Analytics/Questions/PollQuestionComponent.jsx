            ...
            <div className={Style.Wrapper1}>
                <div className={Style.Card}>
                    <div className={Style.Details}>
                        <h2>{assessment[0]?.option1?assessment[0]?.option1:0}</h2>
                        <p className={Style.Text}>Option1</p>
                    </div>
                </div>
                <div className={Style.Card}>
                    <div className={Style.Details}>
                        <h2>{assessment[0]?.option2?assessment[0]?.option2:0}</h2>
                        <p className={Style.Text}>Option2</p>
                    </div>
                </div>
                <div className={Style.Card}>
                    <div className={Style.Details}>
                        <h2>{assessment[0]?.option3?assessment[0]?.option3:0}</h2>
                        <p className={Style.Text}>Option3</p>
                    </div>
                </div>
                <div className={Style.Card}>
                    <div className={Style.Details}>
                        <h2>{assessment[0]?.option4?assessment[0]?.option4:0}</h2>
